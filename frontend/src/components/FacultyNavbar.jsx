      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between h-16 items-center">
          ...
          <div className="hidden md:flex md:items-center space-x-8">
            <CustomNavLink to="/faculty/dashboard">Dashboard</CustomNavLink>
            <CustomNavLink to="/faculty/availability">Availability</CustomNavLink>
            <CustomNavLink to="/faculty/consultations/:id">Consultations</CustomNavLink>
